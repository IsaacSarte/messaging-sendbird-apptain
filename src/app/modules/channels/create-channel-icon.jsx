...
const CreateChannelIcon = ({ onClick }) => {
    ...
    return (
        <div className="sendbird-channel-header__right-icon">
            <button
                className="sendbird-iconbutton w-8 h-8"
                onClick={onClick}
            >
                <div className="sendbird-iconbutton__inner">
                    <div
                        className="sendbird-icon sendbird-icon-create sendbird-icon-color--primary w-6 h-6 min-w-6 min-h-6 cursor-pointer"
                        tabIndex={0}
                    >
